...
%>
	...
	<table align= "center">
			    <tr>
					<td> <a href= "./../<%=serverName%>/api.jsp"  class="btn btn-outline-primary"> Veure esquema GraphQL  </a></td>
			   </tr>
			   <tr>
			   ...
			   <tr>
					<td> <a href= "./../<%=serverName%>/form.jsp"  class="btn btn-outline-primary"> Editar paràmetres de connexió al virtuoso </a></td>
			   </tr>
	</table>
