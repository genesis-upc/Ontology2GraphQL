...
<body> <br><br><br><br>
    ...
    <div class="grid-container">
	  ...
	  <div class="grid-item"><a href= "servidor.html"  class="btn btn-outline-primary btn-lg"> Fer peticions a l'API GraphQL </a></div>
	  <div class="grid-item"><a href= "createWar"  class="btn btn-outline-primary btn-lg"> Descarregar l'aplicació web que conté l'API GraphQL </a></div>
